...
- 🌱Worked on Spring Boot, Microservices, Java 17, Kafka, Kubernetes , CICD, Azure
...
Achievement (Jan 2025 – Sep 2025):
1. Demonstrated strong consistency, discipline, and technical execution by completing 236 days of daily learning (12 books),
2. 18-day hands-on technical challenge using Java, Spring Boot, Microservices, Spring Cloud, JWT, Docker, Kafka
3. Achieved 77 WPM typing speed with 98.2% accuracy. (for high-accuracy typing efficiency and habit building)
